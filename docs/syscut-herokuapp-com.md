...
Rundoc.configure do |config|
  config.project_root = "syscut-herokuapp-com"
...
<!--
  rundoc src:
  Command:
  $ rundoc build --path syscut-herokuapp-com.md
-->
...
```term
:::>- $ git clone https://github.com/heroku/syscut-herokuapp-com
:::>- $ cd syscut-herokuapp-com
:::-- $ git fetch
...
The demo app you deployed already has a `pom.xml` ([see it here](https://github.com/heroku/syscut-herokuapp-com/blob/main/pom.xml)). Here's an excerpt:
...
[Here's the final source code](https://github.com/heroku/syscut-herokuapp-com/blob/localchanges/src/main/java/com/example/Main.java) for `Main.java` - yours should look similar.  [Here's a diff](https://github.com/heroku/syscut-herokuapp-com/compare/localchanges) of all the local changes you should have made.
